...
4. Transpose matrix\n5. Calculate a determinant\n6. Inverse matrix\n0. Exit\nPlease enter the number corresponding to the operation you want to apply:")
        choice = input()
        if choice == "1":
            ...
            tran_choice = input("Please enter the number corresponding to the operation you want to apply: ")
            print("Enter size of matrix: ")
            matrix_a = Matrix(input())
            print("Enter matrix: ")
            matrix_a.create()
